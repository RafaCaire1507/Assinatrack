...
senhaInput.addEventListener("input", () => {
  ...
  if (senha === "") {
    ...
    mensagemSenha.textContent =
      "A senha deve ter no mínimo 8 caracteres, incluindo maiúsculas, minúsculas, número e caractere especial";
    mensagemSenha.style.color = "red";
...
const mensagemConfirmarSenha = document.getElementById(
...
function salvarDadosUsuario() {
  ...
  window.location.href =
    "https://rafacaire1507.github.io/Assinatrack/codigo-fonte/Login-Douglas/Login.html";
}
